...
const MissKobayashisDragonMaid = new Media(
...
const StrangerThings = new Media(
    'Stranger Things',
    10,
    ['adventure', 'sci-fi'],
    '2016',
...
const BeastsOfNoNation = new Media(
    'Beasts of No Nation',
    10,
    ['action'],
    '2015',
...
const DarkWasTheNight = new Media(
    'Dark Was the Night',
    5,
    ['adventure'],
    '2014',
...
const FiveCentimetersPerSecond = new Media(
...
const StarTrekIntoDarkness = new Media(
...
const TheDarkKnightRises = new Media(
...
const ZeroDarkThirty = new Media(
    'Zero Dark Thirty',
    8,
    ['drama'],
    '2012',
